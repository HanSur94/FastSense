...
%     % ...user edits fields, clicks Apply/Close...
    ...
    methods (Access = private)
        ...
        %TOOLTIPMAP Explanations shown as tooltips on each config control.
            infoFileTip = [ ...
                'Path to a Markdown file opened by the Info button. ' ...
                'Empty = built-in placeholder. Relative paths resolve ' ...
                'against the loaded .json directory (or pwd if unsaved).'];
            progressTip = [ ...
                'Render-progress bar visibility: ''auto'' = only for slow ' ...
                'renders, ''on'' = always, ''off'' = never.'];
            timePanelTip = [ ...
                'Show the bottom time-slider panel. Uncheck when widgets ' ...
                'manage their own time range.'];
            m = struct( ...
                ...
                'InfoFile',      infoFileTip, ...
                'ProgressMode',  progressTip, ...
                'ShowTimePanel', timePanelTip);
        end
