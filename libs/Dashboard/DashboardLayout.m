...
%     pos = layout.computePosition([1 1 6 2]);
    ...
    methods (Access = private)
        ...
        %   them. Tag = 'WidgetButtonBar' (protected by sweepUserChildren_).
            ...
            % Sized for 2 buttons (24px each) + 3 gaps of 4px = 60w x 28h.
            % Anchor pixel-positioned at top-right; parent's panel may be
            % normalized — we set Units=pixels just for this child.
