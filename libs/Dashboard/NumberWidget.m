...
%     - A struct with fields: value, unit, trend ('up'/'down'/'flat')
    ...
    methods
        ...
        function render(obj, parentPanel)
            ...
            mutedColor = fgColor * 0.55 + bgColor * 0.45;

            % Phase 4 UI refresh — adaptive KPI layout. Cells with real height
            % get a proper card (title top-left muted, big left-aligned value +
            % inline unit, trend top-right). Very short cells (a couple of grid
            % rows, e.g. an ~11px content panel) fall back to the proven compact
            % single-row layout so nothing clips.
            if pH >= 55
                valueFontSz = max(12, min(30, round(pH * 0.40)));
                titleFontSz = max(8,  min(13, round(pH * 0.16)));
                trendFontSz = max(7,  min(14, round(pH * 0.18)));

                obj.hTitleText = uicontrol('Parent', parentPanel, 'Style', 'text', ...
                    'String', obj.Title, 'Units', 'normalized', ...
                    'Position', [0.07 0.62 0.71 0.30], ...
                    'FontName', fontName, 'FontSize', titleFontSz, 'FontWeight', 'bold', ...
                    'ForegroundColor', mutedColor, 'BackgroundColor', bgColor, ...
                    'HorizontalAlignment', 'left');
                obj.hTrendText = uicontrol('Parent', parentPanel, 'Style', 'text', ...
                    'String', '', 'Units', 'normalized', ...
                    'Position', [0.80 0.62 0.14 0.30], ...
                    'FontName', fontName, 'FontSize', trendFontSz, ...
                    'ForegroundColor', theme.DragHandleColor, 'BackgroundColor', bgColor, ...
                    'HorizontalAlignment', 'right');
                obj.hValueText = uicontrol('Parent', parentPanel, 'Style', 'text', ...
                    'String', '--', 'Units', 'normalized', ...
                    'Position', [0.06 0.05 0.64 0.56], ...
                    'FontName', fontName, 'FontSize', valueFontSz, 'FontWeight', 'bold', ...
                    'ForegroundColor', fgColor, 'BackgroundColor', bgColor, ...
                    'HorizontalAlignment', 'left');
                obj.hUnitText = uicontrol('Parent', parentPanel, 'Style', 'text', ...
                    'String', obj.Units, 'Units', 'normalized', ...
                    'Position', [0.69 0.10 0.26 0.30], ...
                    'FontName', fontName, 'FontSize', titleFontSz, ...
                    'ForegroundColor', mutedColor, 'BackgroundColor', bgColor, ...
                    'HorizontalAlignment', 'left');
            else
                ...
                obj.hTitleText = uicontrol('Parent', parentPanel, 'Style', 'text', ...
                    ...
                    'FontName', fontName, 'FontSize', titleFontSz, 'FontWeight', 'bold', ...
                    'ForegroundColor', fgColor * 0.7 + bgColor * 0.3, 'BackgroundColor', bgColor, ...
                    'HorizontalAlignment', 'right');
                obj.hValueText = uicontrol('Parent', parentPanel, 'Style', 'text', ...
                    'String', '--', 'Units', 'normalized', ...
                ...
                obj.hUnitText = uicontrol('Parent', parentPanel, 'Style', 'text', ...
                    ...
                    'FontName', fontName, 'FontSize', titleFontSz, ...
                    'ForegroundColor', fgColor * 0.5 + bgColor * 0.5, 'BackgroundColor', bgColor, ...
                    'HorizontalAlignment', 'left');
            end
