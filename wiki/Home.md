...
| **SensorThreshold** | Tag‑based sensor data containers (`SensorTag`, `StateTag`, `MonitorTag`, `CompositeTag`, `DerivedTag`), state‑dependent threshold rules, and `TagRegistry` catalog |
...
- **6 built‑in themes** — light, dark, vibrant, muted, colourblind, ocean
- **Linked axes** — synchronised zoom/pan across subplots
- **Tag‑based sensor system** — unified domain model with listeners, lazy evaluation, and disk persistence
...
- [[Examples]] — 40+ categorised runnable examples
