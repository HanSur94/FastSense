...
- [ ] **INFRA-01**: DashboardEngine.LiveTimer has an ErrorFcn that logs errors and keeps the timer running
...
- [ ] **COMPAT-01**: Existing dashboard scripts run without modification
