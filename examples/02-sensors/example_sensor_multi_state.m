...
s_x_ = t;
s_y_ = 50 + 15*sin(2*pi*t/20) + 3*randn(1, numel(t));
s_y_(8000:8200) = s_y_(8000:8200) + 30;   % spike during running
s_y_(25000:25300) = s_y_(25000:25300) - 25; % dip during evacuated
s_y_(45000:45100) = s_y_(45000:45100) + 20; % spike in zone B
