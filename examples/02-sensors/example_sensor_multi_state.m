...
[sx, sy] = s.getXY();
sy(8000:8200) = sy(8000:8200) + 30;       % spike during running
sy(25000:25300) = sy(25000:25300) - 25;    % dip during evacuated
sy(45000:45100) = sy(45000:45100) + 20;    % spike in zone B
s.updateData(sx, sy);
