...
%   so all callbacks see the latest state without handle-class boilerplate.
    ...
    sTemp.addThresholdRule(struct(), 62, ...
        'Direction', 'lower', 'Label', 'Lo Warn', ...
        'Color', [1 0.8 0], 'LineStyle', '--');
    sTemp.addThresholdRule(struct(), 58, ...
        'Direction', 'lower', 'Label', 'Lo Alarm', ...
        'Color', [1 0.2 0.2], 'LineStyle', '-');
    sTemp.resolve();
    ...
    sPress.addThresholdRule(struct(), 68, ...
        'Direction', 'upper', 'Label', 'Hi Alarm', ...
        'Color', [1 0.2 0.2], 'LineStyle', '-');
    sPress.addThresholdRule(struct(), 36, ...
        'Direction', 'lower', 'Label', 'Lo Warn', ...
        'Color', [1 0.8 0], 'LineStyle', '--');
    sPress.addThresholdRule(struct(), 32, ...
        'Direction', 'lower', 'Label', 'Lo Alarm', ...
        'Color', [1 0.2 0.2], 'LineStyle', '-');
    sPress.resolve();
    ...
    sFlow.addThresholdRule(struct(), 135, ...
        'Direction', 'upper', 'Label', 'Hi Warn', ...
        'Color', [1 0.8 0], 'LineStyle', '--');
    sFlow.addThresholdRule(struct(), 145, ...
        'Direction', 'upper', 'Label', 'Hi Alarm', ...
        'Color', [1 0.2 0.2], 'LineStyle', '-');
    sFlow.addThresholdRule(struct(), 95, ...
        'Direction', 'lower', 'Label', 'Lo Warn', ...
        'Color', [1 0.8 0], 'LineStyle', '--');
    sFlow.addThresholdRule(struct(), 85, ...
        'Direction', 'lower', 'Label', 'Lo Alarm', ...
        'Color', [1 0.2 0.2], 'LineStyle', '-');
    sFlow.resolve();
