...
s2.addThresholdRule(@(st) true, 30, ...
    'Direction', 'upper', 'Label', 'High Temp', ...
    'Color', [0.9 0.1 0.1], 'LineStyle', '--');
s2.addThresholdRule(@(st) true, 15, ...
...
s3.addThresholdRule(@(st) true, 5.5, ...
...
s4.addThresholdRule(@(st) st.machine == 1, 65, ...
    'Direction', 'upper', 'Label', 'Flow HH', ...
    'Color', [0.9 0.1 0.1], 'LineStyle', '--');
s4.addThresholdRule(@(st) st.machine == 2, 25, ...
